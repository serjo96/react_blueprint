...
export type UserEntityRolesEnum = typeof UserEntityRolesEnum[keyof typeof UserEntityRolesEnum];
...
export function UserEntityFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserEntity {
    ...
    return {
        ...
        'forgottenPassword': ForgottenPasswordEntityFromJSON(json['forgottenPassword']),
        'emailVerification': EmailVerificationEntityFromJSON(json['emailVerification']),
        'refreshTokens': ((json['refreshTokens'] as Array<any>).map(RefreshTokenFromJSON)),
    };
}
