...
export function EmailVerificationEntityFromJSON(
  json: any
): EmailVerificationEntity {
  return EmailVerificationEntityFromJSONTyped(json, false);
}

export function EmailVerificationEntityFromJSONTyped(
  json: any,
...
export function EmailVerificationEntityToJSON(
  value?: EmailVerificationEntity | null
): any {
  if (value === undefined) {
    return undefined;
  }
