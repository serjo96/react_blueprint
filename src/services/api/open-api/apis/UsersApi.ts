...
export class UsersApi extends runtime.BaseAPI {
   ...
   * Update user data.
   */
  async adminEditUserRaw(
    requestParameters: AdminEditUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UserResponseDto>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling adminEditUser.'
      );
    }

    if (
      requestParameters.adminUpdateUserBodyDto === null ||
      requestParameters.adminUpdateUserBodyDto === undefined
    ) {
      throw new runtime.RequiredError(
        'adminUpdateUserBodyDto',
        'Required parameter requestParameters.adminUpdateUserBodyDto was null or undefined when calling adminEditUser.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/users/admin/{id}`.replace(
          `{${'id'}}`,
        ...
        body: AdminUpdateUserBodyDtoToJSON(
          requestParameters.adminUpdateUserBodyDto
        ),
      },
      initOverrides
    );
  ...
  async adminEditUser(
    ...
    const response = await this.adminEditUserRaw(
      requestParameters,
      initOverrides
    );
  ...
  async editUserRaw(
    ...
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling editUser.'
      );
    }

    if (
      requestParameters.updateUserBodyDto === null ||
      requestParameters.updateUserBodyDto === undefined
    ) {
      throw new runtime.RequiredError(
        'updateUserBodyDto',
        'Required parameter requestParameters.updateUserBodyDto was null or undefined when calling editUser.'
      );
    }
  ...
  async getUserProfileRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<ProfileResponseDto>>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        'id',
        'Required parameter requestParameters.id was null or undefined when calling getUserProfile.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/api/v1/users/profile/{id}`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(requestParameters.id))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(ProfileResponseDtoFromJSON)
    );
  }
  ...
  async getUserProfile(
    requestParameters: GetUserProfileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<ProfileResponseDto>> {
